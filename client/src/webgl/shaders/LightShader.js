...
export class VertexLight {
	...
	createShader(){
		...
		this.mUniformColour		= this.gl.getUniformLocation(this.mShader,"uColorAry");
		...
		this.gl.uniform3fv(this.mUniformColour, new Float32Array( this.mColour ));
		this.gl.uniform1f(this.mUniformPointSize, this.mPointSize);
		this.gl.useProgram(null);
	}

	finalize(){
		this.mVertBuffer = this.gl.createArrayBuffer(new Float32Array(this.mVerts),true);
		this.createShader();
		return this;
	}
